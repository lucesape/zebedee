...
public class DeletedContent {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/deletedContent", method = RequestMethod.GET)
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/deletedContent/{deletedContentId}", method = RequestMethod.POST)
    public String restoreDeletedContent(HttpServletRequest request, HttpServletResponse response, @PathVariable
            long deletedContentId) throws
            ZebedeeException, IOException {
